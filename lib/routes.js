...
Router.map(function () {
  ...
  this.route('homeTemplate',{
    ...
    return $('.content').hide().fadeIn(1000);
     ...
     onBeforeAction: function(){
        console.log('on before action this route:',this);
       Session.set('active_menu_option','home');
       this.next();
     },
     onAfterAction: function(){
      console.log('on after action this route:',this);
    },
    data: function(){
  ...
  this.route('aboutTemplate', {
    ...
    path: '/about',
     onBeforeAction: function(){
        //console.log('on before action this route:',this);
       //ServerSession.set('active_menu_option','about');
  ...
  this.route('contactTemplate', {
    ...
    path: '/contact',
     ...
     onAfterAction: function(){
      console.log('on after action this route:',this.name);
    },
    layoutTemplate: 'mainLayoutTemplate',
    yieldTemplates: {
      'MyAsideTemplate': {
   ...
   this.route('apiTemplate', {
    ...
    path: '/api',
     onBeforeAction: function(){
        console.log('on before action this route:',this.name);
