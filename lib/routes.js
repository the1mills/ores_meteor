...
Router.map(function () {
 ...
 load: function() {
    ...
    waitOn: function() {
  //IRLibLoader.load('http://www.paypertise.com/js/text-editor-lib.js')
    return Meteor.subscribe(COLLECTION_NAMES.PlayerCollection.name);
  },
     onBeforeAction: function(){
       //Session.set('active_menu_option','home');
       on_before_action.footer();
       this.next();
     },
...
//        this.next();
  ...
  this.route('contactTemplate', {
   ...
   this.route('apiTemplate', {
    ...
    data: function(){
      return {active_menu_option: {'openSource':'active'}};
    },
   });
    ...
    where:'client',
      path: '/lbd',
        name:'leaderboardTemplate',
           onBeforeAction: function(){
       //Session.set('active_menu_option','lbd');
       this.next();
           },
    onAfterAction: function(){
      this.next();
     ...
     data: function(){
      return {active_menu_option: {'lbd':'active'}};
    },
  });
